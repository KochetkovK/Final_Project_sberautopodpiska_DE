...
from modules.insert_json import insert_json_copy
...
with DAG(
        dag_id='sberautopodpiska_insert_json_copy',
        schedule=None,
        default_args=args,
) as dag:
    ...
    insert_json_copy = PythonOperator(
        task_id='insert_json',
        python_callable=insert_json_copy,
    )

    clean_json >> insert_json_copy
